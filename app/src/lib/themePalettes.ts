...
export const DEFAULT_THEME_ID = "pixels";

export const FALLBACK_THEMES: ThemePalette[] = [
  {
    id: "pixels",
    name: "Pixels (Default)",
    colors: {
...
export const FALLBACK_THEME_MAP = new Map(FALLBACK_THEMES.map((theme) => [theme.id, theme]));
