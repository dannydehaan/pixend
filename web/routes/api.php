...
Route::prefix('1.0')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('env-vars', [VariableController::class, 'index']);
        Route::post('env-vars', [VariableController::class, 'store']);
        Route::put('env-vars/{variable}', [VariableController::class, 'update']);
        Route::delete('env-vars/{variable}', [VariableController::class, 'destroy']);
        Route::post('env-vars/{variable}/reveal', [VariableController::class, 'reveal']);
        ...
        Route::get('mock-servers', [MockServerController::class, 'index']);
        Route::post('mock-servers', [MockServerController::class, 'store']);
        Route::put('mock-servers/{mock_server}', [MockServerController::class, 'update']);
        Route::delete('mock-servers/{mock_server}', [MockServerController::class, 'destroy']);
    });
});
